...
* Bonita BPM versions currently supported : 6.4.0, 6.4.1, 6.4.2, 6.5.0, 6.5.1, 6.5.2, 6.5.3, 7.0.0, 7.0.1
 ...
 * For Community edition :  
        ...
        cd BonitaBPMCommunity-7.0.1-Tomcat-7.0.55
        tar -czf BonitaBPMCommunity-7.0.1.tgz bonita/ lib/bonita/ webapps/bonita.war
 ...
 * For Performance edition :
    ...
    * if version >= 7 the bonita home is the same for all subscriptions
            ...
            cd /tmp/
            unzip BonitaBPMSubscription-7.0.1-Tomcat-7.0.55.zip
            cd BonitaBPMSubscription-7.0.1-Tomcat-7.0.55
            tar -czf BonitaBPMSubscription-7.0.1.tgz bonita/ lib/bonita/ webapps/bonita.war
...
$bonita_bpm_version = '7.0.1'
$bonita_bpm_edition = 'community'
$bonita_bpm_archive = 'BonitaBPMCommunity-7.0.1.tgz'
include bonita_bpm
```
...
class { 'bonita_bpm':
  version => '7.0.1',
  edition => 'community',
  archive => 'BonitaBPMCommunity-7.0.1.tgz',
}
```
...
The following lists all the class parameters the bonita_bpm class accepts as well as their Top Scope equivalent.
    ...
    version                            bonita_bpm_version                           The Bonita BPM version : 6.4.0, 6.4.1, 6.4.2, 6.5.0, 6.5.1, 6.5.2, 6.5.3, 7.0.0, 7.0.1
